...
wbll = open('new_write_bitline_left_coeff.txt', 'w')
wblr =  open('new_write_bitline_right_coeff.txt', 'w')
wwl  = open('new_write_word_coeff.txt', 'w')
